...
public sealed class Database
{
    ...
    public Database(NotifierConfiguration configuration, ILogger<Database>? logger = null)
    {
        ...
        this._connection = new SqliteConnection(new SqliteConnectionStringBuilder()
        {
    ...
    {
        SqliteCommand command = this._preparedCommands[PreparedCommandType.AddRedirect];
    ...
    {
        SqliteCommand command = this._preparedCommands[PreparedCommandType.IsRedirect];
    ...
    {
        SqliteCommand command = this._preparedCommands[PreparedCommandType.RemoveRedirect];
        command.Parameters[0].Value = guildId;
        command.Parameters[1].Value = channelId;
        command.ExecuteNonQuery();
    }
    ...
    {
        SqliteCommand command = this._preparedCommands[PreparedCommandType.ListRedirects];
        command.Parameters[0].Value = guildId;
        using SqliteDataReader reader = command.ExecuteReader();
        List<ulong> channels = [];
        while (reader.Read())
    ...
    {
        SqliteCommand command = this._preparedCommands[PreparedCommandType.AddIgnoredUser];
    ...
    {
        SqliteCommand command = this._preparedCommands[PreparedCommandType.IsIgnoredUser];
        command.Parameters[0].Value = userId;
        command.Parameters[1].Value = guildId;
        command.Parameters[2].Value = channelId ?? 0;
        using SqliteDataReader reader = command.ExecuteReader();
    ...
    {
        SqliteCommand command = this._preparedCommands[PreparedCommandType.RemoveIgnoredUser];
        command.Parameters[0].Value = userId;
        command.Parameters[1].Value = guildId;
        command.Parameters[2].Value = channelId ?? 0;
        command.ExecuteNonQuery();
    ...
    {
        SqliteCommand command = this._preparedCommands[PreparedCommandType.ListIgnoredUserChannels];
        command.Parameters[0].Value = userId;
        command.Parameters[1].Value = guildId;
        using SqliteDataReader reader = command.ExecuteReader();
        List<ulong> channels = [];
    ...
    {
        SqliteCommand command = this._preparedCommands[PreparedCommandType.AddBlockedUser];
        command.Parameters[0].Value = userId;
        command.Parameters[1].Value = guildId;
    ...
    {
        SqliteCommand command = this._preparedCommands[PreparedCommandType.IsBlockedUser];
        command.Parameters[0].Value = userId;
        command.Parameters[1].Value = guildId;
        command.Parameters[2].Value = blockedUserId;
        using SqliteDataReader reader = command.ExecuteReader();
    ...
    {
        SqliteCommand command = this._preparedCommands[PreparedCommandType.RemoveBlockedUser];
        command.Parameters[0].Value = userId;
        command.Parameters[1].Value = guildId;
        command.Parameters[2].Value = blockedUserId;
        command.ExecuteNonQuery();
    ...
    {
        SqliteCommand command = this._preparedCommands[PreparedCommandType.ListBlockedUsers];
        command.Parameters[0].Value = userId;
        command.Parameters[1].Value = guildId;
        using SqliteDataReader reader = command.ExecuteReader();
    ...
    private FrozenDictionary<PreparedCommandType, SqliteCommand> PrepareCommands()
    {
        ...
        SqliteCommand addRedirectCommand = this._connection.CreateCommand();
        ...
        SqliteCommand isRedirectCommand = this._connection.CreateCommand();
        ...
        SqliteCommand removeRedirectCommand = this._connection.CreateCommand();
        ...
        SqliteCommand listRedirectsCommand = this._connection.CreateCommand();
        ...
        SqliteCommand addIgnoredUserCommand = this._connection.CreateCommand();
        ...
        SqliteCommand isIgnoredUserCommand = this._connection.CreateCommand();
        ...
        SqliteCommand removeIgnoredUserCommand = this._connection.CreateCommand();
        ...
        SqliteCommand listIgnoredUserChannels = this._connection.CreateCommand();
        ...
        SqliteCommand addBlockedUserCommand = this._connection.CreateCommand();
        ...
        SqliteCommand isBlockedUserCommand = this._connection.CreateCommand();
        ...
        SqliteCommand removeBlockedUserCommand = this._connection.CreateCommand();
        ...
        SqliteCommand listBlockedUsers = this._connection.CreateCommand();
    ...
    private void PrepareDatabase()
    {
        ...
        this._logger.LogTrace("Initializing SQL database...");
        this._connection.Open();

        this._logger.LogTrace("Creating SQL tables...");
        using SqliteCommand createTablesCommand = this._connection.CreateCommand();
        ...
        this._logger.LogDebug("Created SQL tables.");

        for (int i = 0; i < this._preparedCommands.Values.Length; i++)
        {
            SqliteCommand command = this._preparedCommands.Values[i];
            this._logger.LogTrace("Preparing command {CommandText}...", (PreparedCommandType)i);
            command.Prepare();
        }
        this._logger.LogDebug("Prepared SQL commands.");
    }
